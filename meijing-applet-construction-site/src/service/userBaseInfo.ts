...
export async function updateSimpleUserInfo(user: UserInfo) {
  return Taro.request({
    url: `/simple-user-server/api/v1/users/current`,
    data: user,
    method: "POST"
  });
}
...
export async function sendVerifyCode(phone: string, isRegister: boolean) {
  return Taro.request({
    method: "POST",
    url: "/simple-user-server/api/v1/auth/verify-code",
    data: {
      phone: phone,
...
export async function decryptPhone(
  ...
  const response = await Taro.request({
    method: "POST",
    url: `/simple-user-server/api/v2/auth/wechat/applet/mj-construction/decrypt-and-bind-register-phone`,
    data: {
...
export async function bindUserPhone(
  ...
  return Taro.request({
    method: "POST",
    url: "/simple-user-server/api/v2/auth/wechat/applet/bind-phone",
    data: {
      phone: phone,
...
export async function updateUserPhone(phone: string, verifyCode: string) {
  return Taro.request({
    method: "POST",
    url: "/simple-user-server/api/v1/users/phone",
    data: {
      phone: phone,
      verifyCode: verifyCode
    }
