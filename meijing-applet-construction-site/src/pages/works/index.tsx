...
export default class Index extends Component<WorksProps, WorksState> {
    ...
    getMoreInspectList = (callback) => {
        ...
        let departmentId = userDetails && userDetails.departmentNode && userDetails.departmentNode.id || 0;
    ...
    render() {
        ...
        let departmentName = userDetails && userDetails.departmentNode && userDetails.departmentNode.name || '我的部门';
                        ...
                        <View className='personalInfo'>
                            ...
                            <View className='userInfo'>
                                <View className='userNameAndDepartment'>
                                    <Text className='username'>{inspect.anonymous ? '匿名用户' : (inspect.reportUserName || '')}</Text>
                                    {
                                        !inspect.anonymous &&
