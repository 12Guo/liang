...
import { departmentUsers, childDivisionUsers, DepartmentUser, DivisionUser, SimpleUser } from '../../service/user'
...
export default class PersonChoose extends Component<PersonChooseProps, PersonChooseState> {
  ...
  async componentDidMount() {
    ...
    let divisionCode = userDetails.pollutionSourceInfo.divisionCode;
