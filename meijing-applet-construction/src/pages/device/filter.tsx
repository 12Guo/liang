...
export default class Filter extends Component<FilterProps, FilterState> {
    ...
    constructor(props) {
        ...
        const workSearchFilter = Taro.getStorageSync('device-search-filter')
        this.state = {
            configList: [
                {
    ...
    saveBack = () => {
        ...
        Taro.setStorageSync('device-search-filter', , { ...configChecked, startTime, endTime })
        Taro.navigateBack()
    }
    ...
    onReset = () => {
        Taro.setStorageSync('device-search-filter', {})
