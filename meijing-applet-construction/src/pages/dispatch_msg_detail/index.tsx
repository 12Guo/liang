...
const upload_msg = rootSourceBaseUrl + '/assets/dispatch_msg_detail/upload_msg.png';
...
export default class DispatchMsgDetailSuccess extends Component<DispatchMsgDetailProps, DispatchMsgDetailState> {
    ...
    onShareAppMessage() {
        ...
        if (reactiveDispatch) {
            ...
            let inspectId = reactiveDispatch.id || 0
        ...
        return {
            title: `响应式调度`,
            path: `/pages/dispatch_msg_detail/index`
        }
    }
    ...
    render() {
        ...
        return (
            <View className='root_view'>
                    ...
                    <View className="dispatch_detail_content">
                                        ...
                                        {replyList.length > 0 && replyList.map((item) => {
                                            return (
                                                <View key={item} className="reply_item">
                                                    <AtAvatar circle image={item.commentUserAvatar}></AtAvatar>
                                        ...
                                        {shareList.map((item) => {
                                            return (
                                                <View key={item.id} className="reply_item">
                                                    <AtAvatar circle image={item.forwardingUserAvatar}></AtAvatar>
                                                    <View className="item_detail">
                                                        <View className="item_head">
                        ...
                        <View className="control_group">
                            <View className="content">
                                ...
                                <View className="group" onClick={this.onReport}>
                                    <Image className="content_image" src={upload_msg}></Image>
                                ...
                                return (
                                    <View key={item} className="reply_item">
                                        ...
                                        <View className="item_detail" onClick={this.handleClick.bind(this, item)}>
                                            ...
                                            <View className="item_body">
                                                {/* 【工业污染】工厂净化设备没有开启，污水直接排入河道造成严重污染，请相关区域人员及时关注 */}
                ...
                <AtActionSheet isOpened={showReportPanel}>
