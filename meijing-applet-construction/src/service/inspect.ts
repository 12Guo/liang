 ...
 * @param flag true:默认 false:事件来源
 * @returns InspectDetail
 */
export async function getInspectDetail(inspectId: number, flag = true) {
    let url = `/meijing-inspect-server/api/v1/inspects/${inspectId}`
    if (!flag) {
