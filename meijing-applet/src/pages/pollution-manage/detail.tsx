...
import { getPollutionDetail, inspectsByPollutantCount, delPollutionDetail } from '../../service/pollutionType';
...
class PatrolPage extends Component<DetailProps, DetailState> {
    ...
    render() {
        const { picIndex, detailData, inspectCount, showPopup } = this.state;
        return (
            <View className='detail-page'>
                ...
                <View className='detail-page__body'>
                    <View className='company-info'>
                        ...
                        <Text className='cate'>{get(detailData, 'pollutionSourceTypeName') || ''}{detailData.industryName ? `-${detailData.industryName}` : ''}</Text>
                    </View>
