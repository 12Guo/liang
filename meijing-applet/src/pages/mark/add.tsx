...
class MarkAdd extends Component<AddProps, AddState> {
    ...
    render() {
        const { showScanDemo, showMore, pollutionTypeList, pollutionStatusList, pollutionStatus, pollutionType, 
            address, existMonitorDevice, linkman, remark, dataObj, departemtList,isSubmitting} = this.state;
        return (
            <View className='add-page'>
                ...
                <View className='add-page_footer'>
                    <Button className='btn-view' type='primary' loading={isSubmitting} disabled={isSubmitting}  onClick={this.onSubmit}>提交</Button>
                </View>
