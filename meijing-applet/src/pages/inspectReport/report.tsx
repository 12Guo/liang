...
export default class InspectReply extends Component<InspectReplyProps, InspectReplyState> {
    ...
    impactDetail() {
        ...
        const path = `${webSite}impact-analysis?divisionCode=${userDetails.divisionCode}&latitude=${latitude}&longitude=${longitude}&title=${encodeURIComponent('影响分析')}`;
        Taro.navigateTo({
                            ...
                            <Block>
                                ...
                                <View className='info_item'>
                                    ...
                                    <View className='item_right'>
                                        ...
                                        <FpiPopupChoose range={pollutionTypeList} rangeKey='name'typeName='请选择污染类型' value={get(pollutionType, 'id', '')} onChange={this.onPollutionTypeChange.bind(this)}>
