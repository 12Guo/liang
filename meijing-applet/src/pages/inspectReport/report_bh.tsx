                ...
                <View className='content-container'>
                    ...
                    <View className='replyinfoView'>
                        ...
                        {type === InspectInfoType.INCIDENT &&
                            <Block>
                                <View className='info_item'>
                                    <Text className='item_left required'>大气污染类型</Text>
                                    <View className='item_right'>
                                        <FpiPopupChoose range={pollutionTypeList} rangeKey='name' typeName='请选择大气污染类型' value={get(pollutionType, 'id', '')} onChange={this.onPollutionTypeChange.bind(this)}>
